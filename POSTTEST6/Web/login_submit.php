<?php
    ...
    $password = mysqli_real_escape_string($con, $_POST['password']);  // Mengambil, mengenkripsi, dan membersihkan kata sandi.
    ...
    if ($rows_fetched == 0) {
        ...
        if ($_SESSION['email'] === $adminEmail) {
            // Jika email sesuai dengan email admin, alihkan ke halaman admin
            header("Location: admin.php"); // Ganti "admin.php" dengan URL halaman admin yang sesuai
            exit;
        }
