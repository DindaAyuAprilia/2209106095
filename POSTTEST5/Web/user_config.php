...
if (isset($_FILES['profile_picture']) && $_FILES['profile_picture']['error'] === UPLOAD_ERR_OK) {
    ...
    echo "Tidak ada berkas yang diunggah atau terjadi kesalahan selama pengunggahan.";
...
$password = md5(md5(mysqli_real_escape_string($con, $_POST['password'])));  // Mendapatkan, mengenkripsi, dan membersihkan kata sandi.
